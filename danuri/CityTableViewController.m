...
{
    if([[self delegate] respondsToSelector:@selector(selectedTableRow:rowData:)])
    {
        [[self delegate] selectedTableRow:indexPath.row rowData:[cityArray objectAtIndex:indexPath.row]];
    }
}
